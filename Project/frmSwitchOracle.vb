...
Public Class frmSwitchOracle

    Dim cn As New OracleConnection
    Dim cmd As New OracleCommand

    Private Sub frmSwitchOracle_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    End Sub

    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            cn.ConnectionString = "Data Source=" + TextBox1.Text + ";User Id=" + TextBox2.Text + ";Password=" + TextBox4.Text
            cn.Open()
            cn.Close()
